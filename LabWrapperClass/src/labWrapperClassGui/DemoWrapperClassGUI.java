...
public class DemoWrapperClassGUI extends JFrame {
	...
	private void createNumberControlPanel() {
		final DemoWrapperClass myDemo = new DemoWrapperClass();
	...
	private void createCharControlPanel() {
		final DemoWrapperClass instance = new DemoWrapperClass();
		...
		btnCharSubmit.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				char c = btnCharSubmit.getText().charAt(0);
				charLabel.setText(instance.charProperties(c));
			}
		});
